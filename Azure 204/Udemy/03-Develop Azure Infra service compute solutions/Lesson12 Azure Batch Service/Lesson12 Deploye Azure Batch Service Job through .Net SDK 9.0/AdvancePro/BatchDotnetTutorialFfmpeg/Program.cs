...
namespace BatchDotnetTutorialFfmpeg
{
    ...
    public class Program
    {
        ...
        private const string BatchAccountName = "m93enbahbatch";
        private const string BatchAccountKey = "cMWeeESL3un+3y0zs+CZBzdi38JcE31vnHUhHMoiClu68juzeiOFruJseJHgiNqV+wv+QBXu4nTRzVJ+EDgFaQ==";
        private const string BatchAccountUrl = "https://m93enbahbatch.westeurope.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "m93enbahstorage";
        private const string StorageAccountKey = "TaTrOo7x8JqM+dZTu2G0F8xEeObWj6ki+oSmup4dWHIgybTDd0BRCvLGBrZfBCz2ZrsEOf1FY7YBuF9tKu+UMQ==";
        ...
        const string appPackageVersion = "4.2";
        ...
        private static async Task MainAsync()
        {
            ...
            const string inputContainerName = "inputs";
            const string outputContainerName = "outputs";
        ...
        private static async Task CreatePoolIfNotExistAsync(BatchClient batchClient, string poolId)
        {
            ...
            try
            {
                ...
                // Download the zipfile https://github.com/GyanD/codexffmpeg/releases/tag/4.3.1-2020-11-08
